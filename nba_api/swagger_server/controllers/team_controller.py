...
def teams_team_id_stats_get(team_id: str, season: str, date_to: str, last_x: int | None = None, home_away_filter: str | None = None) \
        -> dict[str, list[dict]]:
    """
...
def teams_get(team_tickers: list[str], season: str) -> list[dict[str, dict[str, str]]]:
    ...
    for team_ticker in team_tickers:
        team_info = teams_team_ticker_get(team_ticker, season)
