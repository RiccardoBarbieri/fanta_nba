...
public interface OddsApi {
    ...
    @Operation(summary = "Get head-to-head odds", description = "Returns the top 'X' head-to-head odds for a specific event.", tags = {})
    @ApiResponses(value = {
    ...
    @Operation(summary = "Get head-to-head handicap odds", description = "Returns the top 'X' head-to-head handicap odds for a specific event.", tags = {})
    @ApiResponses(value = {
