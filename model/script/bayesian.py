...
# Creazione del modello Bayesian Ridge Regression
...
joblib.dump(bayesian_ridge, 'bayesian_ridge_model.joblib')
joblib.dump(preprocessor, 'preprocessor_bayesian.joblib')
...
feature_importance = bayesian_ridge.coef_
...
random_predictions = bayesian_ridge.predict(random_samples)
...
predicted_diff, actual_diff = predict_game(game_id_to_predict, bayesian_ridge, preprocessor)
