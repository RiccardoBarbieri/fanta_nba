...
# Creazione del modello Support Vector Regression
...
joblib.dump(preprocessor, 'preprocessor_svm.joblib')
...
plt.ylabel('Feature')
plt.title('Feature Importance - Support Vector Regression')
...
random_predictions = svr.predict(random_samples)
...
predicted_diff, actual_diff = predict_game(game_id_to_predict, svr, preprocessor)
