...
# Creazione del modello KNeighborsRegressor
...
joblib.dump(preprocessor, 'preprocessor_knn.joblib')
...
random_predictions = knn.predict(random_samples)
...
predicted_diff, actual_diff = predict_game(game_id_to_predict, knn, preprocessor)
