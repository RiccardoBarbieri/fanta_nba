...
# Creazione del modello Random Forest Regressor con i migliori parametri trovati
...
joblib.dump(preprocessor, 'preprocessor_random_forest.joblib')
...
random_predictions = best_rf.predict(random_samples)
